...
public class Driver {
	public static void main(String[] args) throws IOException {
		...
		//This part is use to see how the reading Property look like
		CreateAuto auto1 = new BuildAuto();
		auto1.BuildAuto("C:\\Users\\hp\\eclipse-workspace\\CIS35B_Lab6_ KhoaPham\\src\\PropertyText101.properties",
				"1");
		auto1.getK("1").printWithoutName();
	}
}

/*
 * public static void main(String[] args) { CreateAuto auto01 = new BuildAuto();
 * auto01.
 * BuildAuto("C:\\Users\\hp\\eclipse-workspace\\CIS35B_Lab3_ KhoaPham\\src\\inputText.txt"
 * , "1"); String[] dataArr = { "Color", "Grabber Green", "SuperGreenTea", "1"
 * }; String[] priceArr = { "Transmission", "0", "100", "1" }; String[]
 * priceArr1 = { "Color", "0", "100", "1" }; String[] wrongSizeArr= {"1"};
 * Scalable e = new BuildAuto();
 * 
 * e.setUpUpdateData(0, dataArr); e.setUpUpdateData(1, priceArr);
 * e.setUpUpdateData(3, priceArr1); e.setUpUpdateData(1, priceArr1);
 * e.setUpUpdateData(0, wrongSizeArr); auto01.printAuto("Focus Wagon ZTW", "1");
 * }
 */
/*
